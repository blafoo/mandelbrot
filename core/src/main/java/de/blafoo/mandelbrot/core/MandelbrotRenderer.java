...
/// Coarse-Pass.
///
/// Die Klasse hält **keinen State** außer dem Executor und der Strip-Anzahl.
/// `renderBlocking` ist reentrant und Thread-safe.
public final class MandelbrotRenderer {
    ...
    private void renderParallel(int[] pixels, RenderParams params,
        ...
        List<Future<?>> tasks = new ArrayList<>(strips);
